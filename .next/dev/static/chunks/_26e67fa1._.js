...
function Header() {
    ...
    const handleCartClick = ()=>{
        ...
        if (cartCount === 0) {
            // If the cart is empty, show a toast notification
            setToast({
                message: "Your cart is empty!.",
                type: "error"
            });
        } else {
            // If the cart has items, open the order modal
            openOrderModal();
        }
    };
...
_s(Header, "KzvNI300qSz716rl2j9sFQqx5h0=", false, function() {
    return [
...
//# sourceMappingURL=_26e67fa1._.js.map